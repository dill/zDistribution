# simple nimble model with just a spline on depth (for Mnov)
...
# Import the data
load("./ProcessedData/detect_data_mnov.RData")
mm.data <- detect_data_mnov

m1.0 <- gam(Detected ~ s(depth, k = 5, bs = "bs"),  
            diagonalize = TRUE, 
            family = "binomial", data = detect_data_mnov, method="REML", 
...
save(nimbleOut_m1.0_2LevelOcc, file = "./Results/nimbleOut_m1.0_2LevelOcc_Mnov.RData")
...
ggsave(plot = p, file = "./Figures/m1.0_nimble2LevOccModel_Mnov.png", 
...
save(post.samples_detectability, file = "./Results/post.samples_detectability_m1.0+2LevelOcc_Mnov.RData")
...
save(Q2_Detectability, file = "./Figures/Q2_DetectabilityByPrimer_Mnov.RData")

ggsave(plot = last_plot(), file = "./Figures/m1.0+2LevelOcc_PDetection_Mnov.png", 
